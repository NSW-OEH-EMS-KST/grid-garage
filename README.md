...
In *grid-garage*, tools inherit from a base tool and decorators are used to implement tool parameters i.e. in *grid-garage* the user interface is generated simply by applying method decorators with suitable arguments. Tool development is simple - follow a pattern from an existing tool.
